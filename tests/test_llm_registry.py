...
_BASELINE: dict[str, object] = {
    ...
    # VISION 默认未绑定（出厂关闭）；需要它的用例用 env() 显式绑端点
    "LLM_ROLE_VISION_ENDPOINT": "none",
    "LLM_ROLE_VISION_MODEL": "",
    "LLM_ROLE_VISION_TEMPERATURE": 0.3,
    "LLM_ROLE_VISION_MAX_TOKENS": 300,
    "LLM_ROLE_VISION_FALLBACK_ENDPOINT": "",
